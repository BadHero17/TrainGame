...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 0.875, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 0.75, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0.625, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0.375, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0.25, 1), glm::vec3(0.2, 0.8, 0.6))
        };
    ...
    {
        VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0.5)),
        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0.75, 0.5)),
        VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0.5, 0.5)),
        VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.25, 0.5)),
    };
    ...
    CreateMesh("tetra", vertices_tetra, indices_tetra);
    ...
    vector<VertexFormat> vertices_square
    {
        VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0.5)),
        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0.75, 0.5)),
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 0.5, 0.5)),
        VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.25, 0.5)),
    };
    ...
    vector<VertexFormat> vertices_ramp
    {
        VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 0.5), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0.5, 0), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
    };


    vector<unsigned int> indices_ramp
    {
        1, 2, 3,
        3, 0, 1,
        3, 4, 0,
    ...
    CreateMesh("ramp", vertices_ramp, indices_ramp);

    vector<VertexFormat> vertices_pac
    {
        ...
        VertexFormat(glm::vec3(0, 1.5, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(1, 2, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(2, 1.5, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        VertexFormat(glm::vec3(2, 0.5, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
    };

    vector<unsigned int> indices_pac
    {
        0, 6, 1,
        0, 1, 2,
        3, 2, 1,
    ...
    CreateMesh("pac", vertices_pac, indices_pac);
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(3.0f, 3.0f, 0), glm::vec3(1.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-3.0f, 3.0f, 0), glm::vec3(1.0f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-3.0f, 2.0f, -3.0f), glm::vec3(2.0f));

    RenderMesh(meshes["ramp"], shaders["VertexColor"], glm::vec3(-5.0f, 0.0f, -3.0f), glm::vec3(1.0f));

    // TODO(student): Disable face culling
    glDisable(GL_CULL_FACE);

    RenderMesh(meshes["pac"], shaders["VertexColor"], glm::vec3(5.0f, 5.0f, -3.0f), glm::vec3(1.0f));
}
