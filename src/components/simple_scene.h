...
struct shipCollider {
    ...
    shipCollider(float cornerX, float cornerY, float width, float height, bool isBumperHead) : cornerX(cornerX), cornerY(cornerY), width(width), height(height), isBumperHead(isBumperHead) {}
    ~shipCollider() {}
};
...
namespace gfxc
{
    ...
    public:
        ...
        static gfxc::SimpleScene* editor;
        static gfxc::SimpleScene* player;
        static bool editorWorld;
    ...
    public:
        ...
        std::vector<shipCollider> shipColliders;
